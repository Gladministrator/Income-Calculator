...
Inherits="Pay_Application.Index" %>
      ...
      <div class="main-app-container">
        ...
        <div class="all-inputs-container">
          ...
          <asp:Label
            ID="Error"
            runat="server"
            Text="Please review fields marked with an asterisk * "
            ForeColor="Black"
            Font-Size="21px"
        ...
        <asp:Panel ID="PanelPayStatement" runat="server" Visible="false" CssClass="payment-panel">
          ...
          <div>
            <asp:Label
              ID="PayTotalHoursWorkedLabel"
              runat="server"
              Text="Total Hours Worked:"></asp:Label>
            <asp:TextBox
              ID="PayTotalHoursWorkedText"
              runat="server"
              ReadOnly="true"
              Width="280px"></asp:TextBox>
          </div>
          ...
          <div>
            ...
            <asp:TextBox ID="PayOvertimeHoursText" runat="server" ReadOnly="true" Width="280px"
              >0</asp:TextBox
            >
          </div>
          <div>
          ...
          <div>
            ...
            <asp:TextBox ID="PayOvertimePayText" runat="server" ReadOnly="true" Width="280px"
              >0</asp:TextBox
            >
          </div>
          <div>
            <asp:Label
              ID="PayTotalGrossPayLabel"
              runat="server"
              Text="Total Gross Pay:"></asp:Label>
            <asp:TextBox ID="PayTotalGrossPayText" runat="server" ReadOnly="true" Width="280px"
              >0</asp:TextBox
            >
          </div>
          <div>
